...
class ActiveRecord
{
    ...
    // Retorna los registros por un orden
    ...
    // Retorna los registros por un orden y con límite
    ...
    // Cuenta los Registros con un array where
    public static function countWhere($array = [])
    {
